        ...
        <div className={styles.page}>
            ...
            <footer className={styles.helpSection}>
                ...
                <ol>
                    ...
                    <li>Добавляйте смены кнопкой "Добавить смену" или двойным кликом по ячейке (десктоп).</li>
                    <li>Редактируйте смену двойным кликом (десктоп) или тапом по карточке (мобайл).</li>
                    <li>Перетаскивайте смены между ячейками на десктопе с помощью drag and drop.</li>
                    <li>На десктопе тяните левый/правый край смены, чтобы изменить начало и конец.</li>
                    <li>Удаление доступно в модалке редактирования кнопкой "Удалить".</li>
                    <li>В режимах Неделя/Месяц при выборе даты таблица скроллится к дню и подсвечивает заголовок.</li>
                </ol>
            </footer>
        </div>
    )
